            ...
            <div class="form">
                ...
                <div class="input-group">
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" id="area_interesse" name="area_interesse">
                        </div>
                        <div class="input-box">
...
if(isset($_POST['submit'])){
    ...
    $clintes = mysqli_query($conexao, "INSERT INTO cadastro(nome, dataNascimento, email, senha, CPF, area_interesse) VALUES ('$nome', '$dataNascimento', '$email', '$senha', '$CPF', '$area_interesse')");
}
